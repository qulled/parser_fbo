...
options.set_preference("browser.download.dir", '~//excel_docs')
options.set_preference("browser.download.downloadDir", '~//excel_docs')
options.set_preference("browser.download.defaultFolder", '~//excel_docs')
